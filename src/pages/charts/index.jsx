...
class index extends React.Component {
  ...
  render() {
    return (<div id='charts'>
       <div id="one" style={{width:'48%',height:300}}></div>
        <div id="two" style={{width:'48%',height:300}}></div>
      <div id="three" style={{width:'48%',height:300}}></div>    
        <div id="four" style={{width:'48%',height:300}}></div> 
    </div>);
  }
}
